...
def parse_args():
    parser = argparse.ArgumentParser(description="Train CNN1DClassifier")
    ...
    parser.add_argument("--run_name", type=str, default="cnn1d_run1")

    parser.add_argument("--window_size", type=int, default=100)
    parser.add_argument("--stride", type=int, default=1)

    parser.add_argument("--conv1_multiplier", type=int, default=4)
    parser.add_argument("--conv2_multiplier", type=int, default=16)
    parser.add_argument("--kernel_size", type=int, default=5)
    parser.add_argument("--conv_stride", type=int, default=5)
...
def main():
    ...
    model = CNN1DClassifier(
        ...
        conv1_multiplier=int(args.conv1_multiplier),
        conv2_multiplier=int(args.conv2_multiplier),
        kernel_size=int(args.kernel_size),
        stride=int(args.conv_stride),
