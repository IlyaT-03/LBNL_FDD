...
def parse_args():
    parser = argparse.ArgumentParser(description="Train NonstationaryTransformerClassifier")
    ...
    parser.add_argument("--run_name", type=str, default="nonstationary_transformer_run1")
...
def main():
    ...
    model = NonstationaryTransformerClassifier(
        ...
        p_hidden_dims=[int(args.p_hidden_dim)] * int(args.p_hidden_layers),
        p_hidden_layers=int(args.p_hidden_layers),
    )
