...
from lbnl_fdd.models.gnn_tam.gnn_tam_gru import GNN_TAM_GRU
...
def parse_args():
    ...
    parser.add_argument("--gru_concat_layers", type=int, choices=[0, 1], default=1)
...
def main():
    ...
    gru_concat_layers=bool(args.gru_concat_layers),
    device=device,
)
